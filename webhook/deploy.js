  ...
  if (req.method === 'POST' && req.url === '/deploy') {
    ...
    req.on('end', () => {
      ...
      const deployCommand = `
                              ...
                              git remote set-url origin https://@github.com/Manoj-Shrees/production-purrfect-pal-studio.git && \
                              ...
                              cd /app/production-purrfect-pal-studio && \
git remote set-url origin https://$GITHUB_TOKEN@github.com/Manoj-Shrees/production-purrfect-pal-studio.git && \
git pull origin main && \
